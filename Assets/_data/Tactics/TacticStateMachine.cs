...
{
    private TacticBaseState currentState;  // Trạng thái hiện tại của đối tượng
    public TacticBaseState CurrentState => currentState;

    // Thiết lập trạng thái ban đầu
    public void Initialize(TacticBaseState startingState)
    {
    ...
    public void ChangeState(TacticBaseState newState)
    {
